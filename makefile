...
data/tidy/portfolio_summ_actblue_incomplete.fst : R/02_portfolio_freq_actblue.R
		Rscript R/02_portfolio_freq_actblue.R
		
data/tidy/portfolio_summ_rightus.fst : R/02_portfolio_freq_rightus.R
		Rscript R/02_portfolio_freq_rightus.R
		
data/tidy/portfolio_summ_winred.fst : R/02_portfolio_freq_winred.R
...
data/tidy/portfolio_summ_actblue.fst : R/03_actblue_fundraisers_match.R
